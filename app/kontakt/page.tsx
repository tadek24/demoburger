        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-100">
              <h2 className="text-3xl font-black mb-8 text-brand-dark">Informacje</h2>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-brand-dark">Lokalizacja</h4>
                    <p className="text-slate-600 font-medium">ul. Główna 1, 33-330 Grybów</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="bg-brand-red/10 p-3 rounded-2xl">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-brand-dark">Email</h4>
                    <a href="mailto:kontakt@maxburger.pl" className="text-slate-600 font-medium hover:text-brand-red transition">
          ...
          {/* Contact Form */}
          <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-100">
            <h2 className="text-3xl font-black mb-8 text-brand-dark">Formularz kontaktowy</h2>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full px-5 py-4 rounded-xl bg-slate-50 border border-slate-200 text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent transition-all"
              ...
              <div>
                ...
                <textarea 
                  rows={5}
                  className="w-full px-5 py-4 rounded-xl bg-slate-50 border border-slate-200 text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent transition-all resize-none"

      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-16">
          <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
            <h2 className="text-3xl font-black mb-6 text-brand-dark">Od pasji do premium fast-foodu</h2>
            ...
            <p className="text-slate-600 leading-relaxed font-medium">
              Zrezygnowaliśmy z półproduktów i mrożonek. Nasze bułki wypiekane są codziennie rano, wołowina to w 100% starannie selekcjonowane mięso z lokalnych ubojni, a sosy przygotowujemy na miejscu. Tak powstał <strong className="text-brand-dark font-bold">Fire Burger</strong>.
            </p>
          </section>

          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-100 flex flex-col justify-center">
              <h3 className="text-2xl font-black mb-4 text-brand-dark">Zaufani, lokalni dostawcy</h3>
              <p className="text-slate-600 leading-relaxed font-medium">
            ...
            <div className="bg-slate-200 rounded-3xl overflow-hidden min-h-[300px] flex items-center justify-center border border-slate-100 group relative flex-col">

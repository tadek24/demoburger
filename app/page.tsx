...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative pb-24 bg-white overflow-hidden">
      <Hero />
      
      {/* Bestsellers Section */}
      <section id="bestsellers" className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        <div className="flex flex-col items-center mb-16 text-center">
          <h2 className="text-4xl md:text-6xl font-black mb-4 tracking-tighter text-brand-dark uppercase">
            Nasze <span className="text-brand-red">Bestsellery</span>
          </h2>
          <p className="text-slate-500 max-w-2xl text-lg font-medium">Najczęściej wybierane klasyki przez naszych gości z całego regionu.</p>
        </div>
      ...
      <section id="dlaczego-my" className="bg-slate-50 border-y border-slate-200 py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-black text-brand-dark leading-[1.1] tracking-tight">
                Dlaczego <span className="text-brand-red">Fire Burger?</span>
              </h2>
              <div className="space-y-6 text-lg text-slate-600 font-medium leading-relaxed">
                <p>
                  Myślisz, <strong className="text-brand-dark font-bold">gdzie zjeść w Grybowie</strong>? Jeśli cenisz smak prawdziwego mięsa, dobrze trafiłeś. Jesteśmy dumni, że nasi goście uznają nas za cel, pod tytułem: <strong className="text-brand-dark font-bold">najlepsza burgerownia w okolicy Nowego Sącza</strong>. 
                </p>
                <p>
            ...
            <div className="relative">
              <div className="aspect-square md:aspect-[4/3] rounded-3xl bg-slate-200 border-2 border-slate-300 flex flex-col items-center justify-center shadow-xl overflow-hidden group">
                {/* Photo Placeholder */}
                <span className="text-8xl group-hover:scale-110 transition-transform duration-500 relative z-10 mb-4 drop-shadow-lg">🍔 🔥 🍕</span>
                <span className="text-sm font-bold text-slate-500 z-10 bg-white/80 px-4 py-2 rounded-full absolute bottom-4 right-4 backdrop-blur">(Zdjęcie: 800x600px - Kuchnia na żywo)</span>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black mb-4 tracking-tighter text-brand-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <h3 className="text-2xl font-black mb-4 text-brand-dark">Burgery Gorlice</h3>
            <p className="text-slate-600 font-medium">Szukasz burgera z prawdziwej wołowiny? Wielu naszych gości przyjeżdża z Gorlic, by zjeść coś wyjątkowego. Wpadnij do nas na solidną porcję mięsa.</p>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <h3 className="text-2xl font-black mb-4 text-brand-dark">Pizza Grybów</h3>
            <p className="text-slate-600 font-medium">Nasz lokal znajduje się w samym sercu Grybowa. Jesteśmy lokalnym punktem na mapie, w którym zjesz najlepszą, gorącą pizzę i rzemieślnicze burgery.</p>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <h3 className="text-2xl font-black mb-4 text-brand-dark">Jedzenie Nowy Sącz</h3>
            <p className="text-slate-600 font-medium">Jesteś w trasie lub szukasz świetnego jedzenia poza Nowym Sączem? Zrób sobie przerwę w Fire Burger. Zamów online na wynos i zgarnij jedzenie po drodze.</p>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
            ...
            <h3 className="text-2xl font-black mb-4 text-brand-dark">Na wynos Stróże i okolice</h3>
            <p className="text-slate-600 font-medium">Mieszkasz w Stróżach? Masz do nas rzut beretem! Przeklikaj swoje zamówienie na stronie i odbierz je ciepłe o wyznaczonej przez Ciebie godzinie.</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 lg:px-8">
          ...
          <div className="space-y-4">
            {FAQS.map((faq, idx) => (
              <div 
                key={idx} 
                className="bg-white border border-slate-200 rounded-2xl overflow-hidden cursor-pointer transition-shadow hover:shadow-md"
                onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
              >
                <div className="p-6 flex justify-between items-center group">
                  <h4 className="font-bold text-lg text-brand-dark pr-8">{faq.q}</h4>
                  <ChevronDown 
